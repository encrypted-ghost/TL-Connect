  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <Button variant="white" size="sm" className="gap-2 font-bold uppercase text-[11px] tracking-widest px-4">
          ...
          users.map((u) => (
            <div key={u.id} className="flex items-center justify-between p-5 bg-[#111114] border border-[#27272a] rounded-xl group hover:border-[#3f3f46] transition-all">
              <div className="flex items-center gap-5">
                <div className="w-12 h-12 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-indigo-400 font-bold text-lg uppercase shadow-inner">
                  {u.email[0]}
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <Button variant="ghost" size="icon" className="h-9 w-9 text-neutral-600 hover:text-red-400 hover:bg-red-500/10">
                  <Trash2 size={18} />
                </Button>
              </div>
            </div>
