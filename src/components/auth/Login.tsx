      ...
      <div className="w-full max-w-[420px] space-y-8">
        <div className="flex flex-col items-center text-center space-y-6">
          <div className="relative group">
            ...
            <div className="relative w-20 h-20 rounded-2xl bg-white/5 flex items-center justify-center shadow-2xl overflow-hidden">
              <img src="/tl-connect-logo.png" alt="Logo" className="w-full h-full object-contain animate-in zoom-in duration-500" />
            </div>
